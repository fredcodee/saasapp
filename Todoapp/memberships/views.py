...
def stripe_webhook(request):
    ...
    if event['type'] == 'checkout.session.completed':
        ...
        new_sub = UserSubsription(user_membership = user_membership, stripe_subscription_id = user_subscription_id, active = True)
        new_sub.save()

        print(user_subscription_id)
        print(sub_price_id)
        print(new_sub.stripe_subscription_id )
